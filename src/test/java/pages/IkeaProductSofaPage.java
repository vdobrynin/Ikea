...
public class IkeaProductSofaPage extends Page {
  ...
  @FindBy(xpath = "(//*[name()='svg'][@class='pip-svg-icon pip-btn__icon'])[1]")
  ...
  public void search(String text) {
    getExecutor().executeScript("arguments[0].scrollIntoView(true);", headerSearch);
    getWait().until(ExpectedConditions.visibilityOf(headerSearch));
    getExecutor().executeScript("window.scrollBy(0,-250)");
